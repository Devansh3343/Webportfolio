...
>
  <div className="w-[350px] h-[350px] bg-[url('/Home/profilepicture.png')] bg-no-repeat bg-center bg-cover shadow-inner rounded-full animate-profile__animate relative border-[4px] border-white/30 backdrop-blur-md" >
